...
if not query_files:
    ...
    default_query = query_files[0] 
    default_query_path = os.path.join(QUERY_DIR, default_query)
...
st.session_state.query_text = st.text_area("📝 Enter your SPARQL query:",st.session_state.query_text, height=200 )
...
if st.button("Execute Query"):
    ...
    try:
        ...
        results = store.query(st.session_state.query_text)
