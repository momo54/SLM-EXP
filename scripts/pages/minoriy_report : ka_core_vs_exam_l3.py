...
g = rdflib.Graph()
TTLS = ["./XP/ka_core_results/bok_ka_core_no_hours.ttl", "./XP/ka_core_results/exam_l3.ttl", "./data/exam_l3_merged.ttl"]
for ttl in TTLS:
    try:
...
st.title("🧪 Minority Report des examens de L3 vs ka_core ")
