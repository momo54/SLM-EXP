...
g = rdflib.Graph()
TTLS = ["./XP/graph_bok_nohours.ttl", "./XP/new_description/new_description_aligned.ttl", "./data/new_description_converted.ttl"]
for ttl in TTLS:
    try:
...
st.title("🧪 Results of : the new description of courses ")
