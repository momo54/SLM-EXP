...
g = rdflib.Graph()
TTLS = ["./XP/cs_core_results/bok_graph_cs_core_no_hours.ttl", "./XP/cs_core_results/exam-align.ttl", "./data/exam_l3_merged.ttl"]
for ttl in TTLS:
    try:
...
st.title("🧪 Minority Report des examens de L3 vs cs_core ")
